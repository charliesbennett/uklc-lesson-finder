...
export default function UKLCLessonManager() {
  ...
  const commonTags = ['A1', 'A2', 'B1', 'B2', 'C1', 'C2', 'Language Focus', 'Leadership Focus', 'Culture Focus', 'Outdoor Lesson', 'Art Lesson', 'Science Lesson', 'Technology Lesson', 'Grammar', 'Speaking', 'Writing', 'Reading', 'Listening'];
